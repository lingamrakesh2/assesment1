...
CxxTest::StaticSuiteDescription suiteDescription_SampleTestSuite( "test.h", 7, "SampleTestSuite", suite_SampleTestSuite, Tests_SampleTestSuite );
...
public:
 TestDescription_suite_SampleTestSuite_testTwo2() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 18, "testTwo2" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testThree3() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 25, "testThree3" ) {}
